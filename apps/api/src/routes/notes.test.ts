import { createNoteSchema, searchQuerySchema, updateNoteSchema } from '@graphite/shared';
...
describe('Notes Routes', () => {
  ...
  describe('GET /:id', () => {
    it('should return note by id', async () => {
      ...
      const json = await res.json();
      expect(json).toEqual({ data: mockNotes[0] });
      expect(mockService.getById).toHaveBeenCalledWith('11111111-1111-4111-8111-111111111111');
    });
  ...
  describe('PUT /:id', () => {
    it('should update a note', async () => {
      ...
      expect(mockService.update).toHaveBeenCalledWith('11111111-1111-4111-8111-111111111111', {
        title: 'Updated Title',
      });
    });
